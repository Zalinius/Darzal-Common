...
class HexagonGridCircularTest {
	...
	@Test
	void computeSize_withNegativeRadius_throwsIllegalArgumentException() {
		assertThrows(IllegalArgumentException.class, () -> HexagonGridCircular.computeSize(-1));
	}
	...
	@Test
	void computeMinimumRadius_withNegativeGridSize_throwsIllegalArgumentException() {
		assertThrows(IllegalArgumentException.class, () -> HexagonGridCircular.computeMinimumRadius(-1));
	}
