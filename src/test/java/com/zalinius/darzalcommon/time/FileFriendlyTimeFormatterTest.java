...
class FileFriendlyTimeFormatterTest {
	...
	@Test
	void dateTimeFileFriendlyUTC_onEpochInstant_formatsWell() throws Exception {
		Instant time = Instant.EPOCH;
	...
	@Test
	void fileFriendlyTimeFormatter_inEST_createsFileFriendlyUTCTimeFormatter() throws Exception {
